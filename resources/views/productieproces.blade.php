    ...
    <div class="bg-[#D5DBE6] text-rb-dark-blue">
        <div class="container mx-auto flex px-5 md:px-0">
            <div class="my-6">
                ...
                <p class="text-lg mt-4 font-bold leading-6">
                    Dankzij onze samenwerkingen met producenten zoals Accell en
                    Van Moof hebben we tot nu toe al 1 miljoen batterijcellen
                    kunnen redden van de shredder. Maar wat ons betreft is dit
                    nog maar het begin. Werk jij mee aan het succes?
                </p>
                <a
                    href="{{ route("contact") }}"
                    class="mt-6 inline-block bg-rb-green px-3 py-1 text-white duration-100 hover:bg-rb-dark-blue hover:underline"
