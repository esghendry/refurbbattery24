<x-app-layout>
    ...
    <div class="bg-[#E5E7EB]">
        <div class="container px-5 pb-6 mx-auto md:px-0">
            <div class="relative flex flex-wrap justify-center w-full -mt-8">
                <div class="w-full p-3 sm:w-1/2 xl:w-1/3">
                    <div
                        class="h-full transition-all rounded-md shadow-md cursor-pointer bg-gray-50 hover:scale-110 hover:bg-gray-100">
                        <a href="/werken-bij/product-specialist-battery-pack-designer"
                            ...
                            <span class="block p-2">
                                Product Specialist | Battery Pack Designer
                            </span>
                        </a>
                    </div>
                </div>
                ...
                <div class="w-full p-3 sm:w-1/2 xl:w-1/3">
                    <div
                        class="h-full transition-all rounded-md shadow-md cursor-pointer bg-gray-50 hover:scale-110 hover:bg-gray-100">
                        <a href="/werken-bij/quality-process-engineer-manufacturing"
                            class="block h-full mb-2 text-base font-bold no-underline uppercase font-mulish hover:underline sm:text-lg md:text-xl">
                            <span class="block w-full bg-cover h-44"
                                style="
                ...
                <div class="w-full p-3 sm:w-1/2 xl:w-1/3">
                    <div
                        class="h-full transition-all rounded-md shadow-md cursor-pointer bg-gray-50 hover:scale-110 hover:bg-gray-100">
                        <a href="/werken-bij/technical-sales-manager-energieopslagsystemen-eos"
                            class="block h-full mb-2 text-base font-bold no-underline uppercase font-mulish hover:underline sm:text-lg md:text-xl">
                            <span class="block w-full bg-cover h-44"
                                style="
                            ...
                            <span class="block p-2">
                                Technical Sales Manager | Energieopslagsystemen
                                (EOS)
                            </span>
                        </a>
                    </div>
            ...
            <div class="p-6 mb-12 italic bg-white sm:p-8 md:p-12">
                <div style="text-align: center">
                    <span
                        ...
                        ">
                        "Werken bij Refurb Battery betekent elke dag pionieren. We worden gedreven door samenwerking,
                        innovatie en duurzaamheid. Ben jij die innovator met technische affiniteit en wil je je steentje
                        bijdragen aan groene groei? Dan is onze energie een match."
                    </span>
                </div>
            </div>

            <div class="grid w-full grid-cols-3 gap-4 mx-auto text-dark-blue place-items-center md:place-items-start">
                <div class="col-span-3 pt-6 text-center md:col-span-1">
                    ...
                    <small>
                        ...
                        <a href="https://www.linkedin.com/in/daandewin/" class="!font-normal underline" target="_blank">
                            LinkedIn
                        </a>
                        <br />
                        <svg class="inline" width="16px" height="16px" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg" fill="#000000" stroke="#000000" stroke-width="0.0002">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
