<x-app-layout>
    <x-page-header>
        ...
        @section("subtitle", "Sluit je bij ons aan en maak het verschil")
    </x-page-header>
        ...
        <div class="container mx-auto px-5 pb-6 md:px-0">
            <div class="relative -mt-8 flex w-full flex-wrap justify-center">
                <div class="w-full p-3 sm:w-1/2 xl:w-1/3">
                    ...
                    >
                        <a
                            href="/werken-bij/product-specialist-battery-pack-designer"
                ...
                <div class="w-full p-3 sm:w-1/2 xl:w-1/3">
                    ...
                    >
                        <a
                            href="/werken-bij/quality-process-engineer-manufacturing"
                            class="mb-2 block h-full font-mulish text-base font-bold uppercase no-underline hover:underline sm:text-lg md:text-xl"
                        >
                            <span
                                class="block h-44 w-full bg-cover"
                ...
                <div class="w-full p-3 sm:w-1/2 xl:w-1/3">
                    ...
                    >
                        <a
                            href="/werken-bij/technical-sales-manager-energieopslagsystemen-eos"
                            class="mb-2 block h-full font-mulish text-base font-bold uppercase no-underline hover:underline sm:text-lg md:text-xl"
                        >
                            <span
                                class="block h-44 w-full bg-cover"
            ...
            <div class="mb-6">
                <h1
                    class="block text-center font-mulish text-xl font-bold sm:text-2xl md:text-left md:text-3xl"
                >
                    Gedreven door cultuur.
                </h1>
            </div>
            <div class="mb-12 bg-white p-6 italic sm:p-8 md:p-12">
                <div style="text-align: center">
                    <span
                        ...
                        "
                    >
                        "At Refurb Battery, our mission is to make a huge impact
                        on sustainability while minimizing impact on our global
                        environment. We're aiming to be the changemaker in green
                        energy storage solutions. Our mission has already been
                        rewarded with the 'Rabo Duurzame Innovatie' Member's
                        Award and the 'Brabantse Circulaire Innovatie' Award.
                        Now is the time for change, so join our team. Our energy
                        matches when you're a born innovator, ready to pioneer
