<div class="p-6 text-white bg-rb-dark-blue">
    @if ($isSent)
        <div class="flex w-full">
            <div class="inline-flex items-center w-10/12 p-4 mx-auto bg-rb-green">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="mr-2 size-10">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                    </svg>
                </div>
                <p class="notyf__message">
                    Bedankt! We hebben je sollicitatie ontvangen en nemen zo snel mogelijk contact met je op.
                </p>
            </div>
        </div>
    @endif
    ...
    @if (!$isSent)
        <form enctype="multipart/form-data" class="mx-auto lg:max-w-none" wire:submit="submit">
            <div class="grid w-full grid-cols-2 gap-6">
                <div class="col-span-2 sm:col-span-1">
                    <div class="relative flex items-center w-full group">
                        <input type="text" id="first-name" wire:model="firstName"
                ...
                <div class="col-span-2 sm:col-span-1">
                    <div class="relative flex items-center w-full group">
                        <input type="text" id="last-name" wire:model="lastName"
                            class="peer mb-2 block w-full border-0 border-b border-rb-green bg-transparent p-0 py-2.5 outline-none focus:border-white focus:ring-0"
                            placeholder="" required />
                        <label for="last-name"
                            class="pointer-events-none absolute top-3 origin-[0] -translate-y-6 scale-75 transform text-sm duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:-translate-y-6 peer-focus:scale-75">
                ...
                <div class="col-span-2 sm:col-span-1">
                    <div class="relative flex items-center w-full group">
                        <input type="text" id="languages" wire:model="languages"
                            class="peer mb-2 block w-full border-0 border-b border-rb-green bg-transparent p-0 py-2.5 outline-none focus:border-white focus:ring-0"
                            placeholder="" />
                        <label for="languages"
                            class="pointer-events-none absolute top-3 origin-[0] -translate-y-6 scale-75 transform text-sm duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:-translate-y-6 peer-focus:scale-75">
                ...
                <div class="col-span-2 sm:col-span-1">
                    <div class="relative flex items-center w-full group">
                        <input type="text" id="how-did-you-find-us" wire:model="howDidYouFindUs"
                            class="peer mb-2 block w-full border-0 border-b border-rb-green bg-transparent p-0 py-2.5 outline-none focus:border-white focus:ring-0"
                            placeholder="" />
                        <label for="how-did-you-find-us"
                            class="pointer-events-none absolute top-3 origin-[0] -translate-y-6 scale-75 transform text-sm duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:-translate-y-6 peer-focus:scale-75">
                ...
                <div class="col-span-2">
                    <button type="submit"
                        ...
                        <span
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 fill-none stroke-white"
                                viewBox="0 0 512 512">
                    ...
                    <p class="linkEffects mt-2 text-center text-xs leading-[1.5]">
                        Door te verzenden ga ik akkoord met Refurb Battery die
                        mijn persoonlijke gegevens verwerkt in overeenstemming
                        met haar
                        <a class="!font-normal underline" href="{{ route('privacy-and-cookies') }}" target="_blank">
                            privacybeleid
                        </a>
                        .
                        <br />
