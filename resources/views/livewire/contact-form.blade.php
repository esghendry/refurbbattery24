<div>
    <div class="p-6 text-white bg-rb-dark-blue">
        ...
        @if (!$isSent)
            <form wire:submit="submit" class="max-w-lg mx-auto">
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div class="relative inline-block w-full group col-span-full">
                        <textarea type="text" id="message" wire:model="message"
                            class="peer mb-2 block w-full border-0 border-b border-rb-green bg-transparent p-0 py-2.5 outline-none focus:border-white focus:ring-0"
                    ...
                    <div class="col-span-2">
                        ...
                        <p class="linkEffects mt-2 text-center text-xs leading-[1.5]">
                            ...
                            <a class="!font-normal underline" href="/privacy-and-cookies" target="_blank">
                                privacy policy
                            </a>
                            .
                        </p>
