<div class="col-span-3 pt-6 text-center md:col-span-1">
    ...
    <div class="my-2">
        @hasSection("contact_subtitle")
            @yield("contact_subtitle")
        @else
                Neem contact op met
        @endif
    </div>
    ...
    <div
        ...
        style="
            max-width: 15rem;
            background-image: url('{{ $user->image ? Storage::disk("do")->url($user->image) : "" }}');
        "
    ></div>
    ...
    <div class="linkEffects mt-4">
        @if ($user->socials && count($user->socials) > 0)
            @foreach ($user->socials as $social)
                <div>
                    @switch($social["platform"])
                        ...
                        @case("email")
                            <a
                                href="mailto:{{ $social["url"] }}?subject=Question%20about%20vacancies"
