<div class="z-50">
    <div class="{{ $height }} relative min-h-[150px] w-full bg-[#FFBB00]">
        <div
            ...
            "
            class="absolute inset-0 flex h-full items-center overflow-hidden"
        >
        ...
        <div class="absolute inset-0 z-50 size-full">
            <div class="container mx-auto size-full items-center px-5 md:px-0">
                <div
                    class="relative grid size-full gap-2 md:grid-cols-12 md:gap-12"
                >
