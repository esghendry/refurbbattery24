<a href="{{ $url }}" class="{{ $classes }} group relative block size-full bg-cover p-6 text-rb-dark-blue"
    style="background-image: url('{{ $img }}')">
    <div class="absolute inset-0 z-10 hidden size-full bg-rb-dark-blue/30 group-hover:block"></div>
