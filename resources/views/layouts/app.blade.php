...
<body class="flex min-h-screen w-full flex-col font-mulish bg-[#E5E7EB]">
    <header class="sticky top-0 z-[99] overflow-hidden">
        <x-nav-bar />

        <div class="linkEffects bg-[#E5E7EB] text-rb-dark-blue hidden md:block">
    ...
    <footer>
        <div class="font-mulish">
            {{-- <div class="">
                    ...
                    >
                        <div
                            class="relative flex flex-wrap items-center justify-center gap-6 px-5 mx-auto my-6 text-center"
                        >
                            ...
                            >
                                Get in Touch
                                <span
                                    class="w-0 pt-1 overflow-hidden transition-all group-hover:w-5 group-hover:pl-1 group-focus:w-5 group-focus:scale-100"
                                >
                                    <svg
            ...
            <div class="text-white bg-rb-dark-blue">
                <div class="container flex items-center h-full px-5 py-12 mx-auto md:px-0">
                    <div class="grid w-full gap-6 md:grid-cols-12">
                        <div class="text-center md:col-span-4 md:text-left">
                            <a href="{{ route('home') }}">
                                <img src="{{ generalSettings()->logo ? Storage::disk('do')->url(generalSettings()->logo) : asset('assets/logos/RB_Logo.svg') }}" alt="Refurb Battery logo"
                                    class="mx-auto h-7 md:mx-0" />
                            </a>
                            <div class="my-6">
                                <p>Let's talk</p>
                                <a href="tel:{{ contactSettings()->phone }}"
                                    class="flex items-center mx-auto underline md:mx-0 w-fit hover:no-underline">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2 fill-white"
                                        viewBox="0 0 512 512">
                                        <title>Call</title>
                                        <path
                                    ...
                                    {{ (new \Propaganistas\LaravelPhone\PhoneNumber(contactSettings()->phone))->formatNational() }}
                                </a>
                                ...
                                <div class="py-2 ">
                                    <a href="https://nl.linkedin.com/company/refurb-battery" target="_blank"
                                        class="inline-block px-1 text-xl text-grey-blue hover:text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 fill-white"
                                            viewBox="0 0 512 512">
                                    ...
                                    <a href="https://www.instagram.com/refurb.battery" target="_blank"
                                        class="inline-block px-1 text-xl text-grey-blue hover:text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 fill-white"
                                            viewBox="0 0 512 512">
                        ...
                        <div class="flex items-center md:col-span-8">
                            <x-footer-links />
                        </div>
                    </div>
                </div>
